  ...
  return (
    <>
      <div className='Temp_Item'>
        <h1>{weekday[new Date(data.dt_txt).getDay()]} Outlook : {dayjs(data.dt_txt).format('DD, MMM')}</h1>
        <div className='Temp_Item-Container'>
          ...
          <div className='Temp_Item-left-item2'>
            ...
            <div className='Detail-item'>
              ...
              <p>Wind: {data.wind.speed} {CF === 'C' ? 'm/s' : 'miles/h'}</p>
            </div>
          </div>
          <div className='Temp_Item-right'>
            ...
            <div className='Detail-item'>
              ...
              <p className='tempclick' onClick={TempChange}>Real Feel: {data.main.feels_like} °</p>
            </div>
            <div className='HighLow'>
              <div className='HighLow-Left'>
                <BiUpArrowAlt className='UpIcon' />
                <p onClick={TempChange}>High: {data.main.temp_max.toFixed(0)} °</p>
              </div>
              <div className='HighLow-Right'>
                <BiDownArrowAlt className='DownIcon' />
                <p onClick={TempChange}>Low: {data.main.temp_min.toFixed(0)} °</p>
              </div>
            </div>
          </div>
        </div>
